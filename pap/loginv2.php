...
<body style="width: 100%;height: 100%;background-color: rgb(241,247,252);">
    <div class="login-clean" style="width: 100%;height: 100%;">
        <form method="post">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" id="login" type="button" data-bs-hover-animate="shake" style="background-color: rgb(165,255,150);">Log In</button></div><a class="forgot" href="#">Forgot your email or password?</a></form>
    </div>
